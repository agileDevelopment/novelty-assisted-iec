 ...
 */
public class FastestEuclidianDistance extends FitnessStrategy {

    /**
     * 
     * @param maze 
     */
    public FastestEuclidianDistance(Maze maze) {
        super(maze);
    }
    ...
    public int calculateFitness(Path path) {
        ...
        int fitness = 2 * MAX_FITNESS - (int) Math.round(distance) - path.size();
        
//        System.out.println("Fitness = " + fitness + ", Distance = " + distance + ", Time = " + path.size());
        return fitness;
    }
}
