...
import edu.ucf.eplex.naiecFramework.domain.NaiecDomainProperties;

/**
 *
 * @author Brian Woolley <brian.woolley at ieee.org>
 */
public class Evolver implements EvaluationFunction, PopulationListener {
    ...
    private static final long serialVersionUID = 8906408536458970436L;
    ...
    public static void main(String[] args) throws ClassNotFoundException, InstantiationException, IllegalAccessException, IOException, InvalidConfigurationException, Exception {
        ...
        NaiecDomainProperties props = new NaiecDomainProperties(args[1]);
    ...
    public double getChampAdjustedFitness() {
        return (fitnessChamp == null) ? 0d : (double) fitnessChamp.getFitnessValue()
    ...
    private void init(Properties props) throws IOException, InvalidConfigurationException {
        ...
        maxFitness = f_domain.getMaxFitnessValue();
...
//        }
    ...
    public void run() {
        ...
        double adjustedFitness = (maxFitness > 0 ? fitnessChamp.getFitnessValue() / maxFitness : fitnessChamp.getFitnessValue());
        ...
        for (int generation = 0; (generation < numEvolutions && adjustedFitness <= targetFitness); ++generation) {
            ...
            adjustedFitness = (maxFitness > 0 ? (double) fitnessChamp.getFitnessValue() / maxFitness : fitnessChamp.getFitnessValue());
            ...
            if (adjustedFitness >= targetFitness) {
                break;
            }
        }
