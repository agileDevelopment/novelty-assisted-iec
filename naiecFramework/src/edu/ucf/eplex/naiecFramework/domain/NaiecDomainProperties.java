 ...
 */
public class NaiecDomainProperties extends Properties {

    public NaiecDomainProperties(String string) throws IOException {
        super(string);
    }
    
    public NaiecDomainProperties() {
        super();
