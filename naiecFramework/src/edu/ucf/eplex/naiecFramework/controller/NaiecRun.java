 ...
 */
public class NaiecRun implements XmlPersistable {
...
//        }
    ...
    public void loadFromXml(List<Document> docs) {
        for (Document doc : docs) {
            NaiecRun subSession = new NaiecRun("unknown");
...
//                    }
    ...
    public int fitnessAtEvaluation(int evaluationTarget) {
        int champFitness = 0;
